...
---- Wetlands
  ...
  { --[[ wetland: tanai                          ]]    "nodes_nature:tanai"              , "simple"   , wetland_on                         , nil,           80,     0.800000,  nil                                                                                                              ,     lowland_max,     beach_max, "nodes_nature:tanai"               , nil          , nil,         nil                  , nil                             ,      nil,   4,   nil, },
  ...
  { --[[ rich forest: damo                       ]]    "nodes_nature:damo"               , "simple"   , rich_forest_on                     , nil,           80,     0.800000,  nil                                                                                                              ,     highland_max,    beach_max, "nodes_nature:damo"                , nil          , nil,         nil                  , nil                             ,      nil,   4,   nil, },
